...
<script>
    ...
    function showNotifToast(message, type = 'success') {
        ...
        const iconName = isDanger ? 'alert-circle' : 'check-circle';
        const borderColor = isDanger ? 'border-rose-500/30' : 'border-emerald-500/30';
        const iconColor = isDanger ? 'text-rose-400' : 'text-emerald-400';
        const glowColor = isDanger ? 'shadow-rose-500/10' : 'shadow-emerald-500/10';
