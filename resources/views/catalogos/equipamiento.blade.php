...
<div class="space-y-8 animate-fade-in">
    ...
    <div class="bg-slate-900/40 border border-slate-800 rounded-3xl overflow-hidden shadow-xl">
        ...
        <div id="equipment_pagination_container" class="p-4 border-t border-slate-850 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-medium text-slate-400">
            <span id="equipment_pagination_info">Mostrando equipos...</span>
            <div class="flex items-center gap-2">
                <button type="button" id="prev_page_btn" onclick="changeEquipmentPage(-1)" class="px-3.5 py-1.5 bg-slate-950 border border-slate-850 rounded-xl text-slate-300 hover:text-slate-100 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer transition-colors font-bold flex items-center gap-1">
                ...
                <button type="button" id="next_page_btn" onclick="changeEquipmentPage(1)" class="px-3.5 py-1.5 bg-slate-950 border border-slate-850 rounded-xl text-slate-300 hover:text-slate-100 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer transition-colors font-bold flex items-center gap-1">
                    Siguiente
...
<script>
    ...
    function initEquipmentPagination() {
        updateCounters();
        renderEquipmentPage();
    }
