...
class CashierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $cashier = Cashier::create([
                ...
                'assigned_register' => $request->assigned_register ?? 'all',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'phone' => 'nullable|string|max:20',
            'shift' => 'nullable|string|max:100',
            'assigned_register' => 'nullable|string|in:all,memberships,pos',
            'hire_date' => 'nullable|date',
            'salary' => 'required|numeric|min:0',
            'photo' => 'nullable|image|mimes:jpeg,png,jpg,svg,gif,webp|max:2048',
            'notes' => 'nullable|string',
        ...
        try {
            ...
            $cashier->update([
                ...
                'phone' => $request->phone,
                'shift' => $request->shift ?? 'Mañana (06:00 - 14:00)',
                'assigned_register' => $request->assigned_register ?? $cashier->assigned_register ?? 'all',
